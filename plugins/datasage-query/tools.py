    ...
    def execute(
        ...
        *,
        ...
        try:
            ...
            if self.connection is None or self.closed or self.marker is None:
                raise QueryFailure(
                    "QUERY_FAILED",
    ...
    *,
    ...
    if request["mode"] == "metric":
        def exact_lookup(sql: str, params: Sequence[Any], limit: int):
            ...
            return _execute(sql, params, limit, deadline_at=deadline_at)
...
def _run_one(
    ...
    *,
    ...
    execute_query: Callable[..., tuple[list[dict[str, Any]], bool]] | None = None,
    ...
    try:
        ...
        executor = execute_query or _execute
...
def _datasage_query_with_slot(args: dict[str, Any], **_kwargs: Any) -> str:
    ...
    try:
        ...
        if len(requests) > 10:
            raise QueryFailure(
                "INVALID_INPUT",
                "Expanded complete change decompositions exceed the ten-request execution budget.",
            )
