        ...
        "properties": {
            "requests": {
                ...
                "description": (
                    ...
                    "order, and give each input a unique request_id. A complete_change_decomposition operation expands to two "
                    "physical requests that count against the same ten-request execution budget."
                ),
            },
            "calculations": {
                "type": "array",
