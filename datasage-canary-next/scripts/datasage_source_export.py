...
_ROOT_FILES = (
    ...
    "tests/test_currency_db_verified_contracts.py",
    "tests/test_dso_original_currency.py",
    "tests/test_target_currency_scope.py",
    ...
    "docs/currency-source-verification-20260926.md",
...
_TEST_FILES = _paths(
    ...
    (
        ...
        "test_remediation_catalog_consistency.py",
        ...
        "test_remediation_settlement_counts.py",
        "test_remediation_statement_limits.py",
        "test_remediation_target_formula.py",
