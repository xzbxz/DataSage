...
class DistributionBoundaryTests(unittest.TestCase):
    ...
    def test_wecom_uses_minimal_datasage_surface(self):
        ...
        self.assertNotIn("code_execution", resolved)
        self.assertNotIn("skills-readonly", resolved)
        self.assertIn("skills", resolved)
        self.assertIs(parsed_config["skills"]["write_approval"], True)
        self.assertIs(parsed_config["skills"]["inline_shell"], False)
        self.assertTrue(
